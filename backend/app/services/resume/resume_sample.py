...
def sample_resume_content() -> ResumeContent:
    ...
    return ResumeContent(
        ...
        city="上海",
        summary="3 年市场与运营经验，主导过从 0 到 1 的会员增长项目，"
        ...
        campus_experience=[
            ResumeCampusExperience(
                ...
                end_date="2022.06",
                description=[
                    "统筹 6 场校园活动的宣传排期，协调 8 人小组分工，累计触达 3000 余人次。"
                ],
            )
        ],
        projects=[
            ResumeProject(
                ...
                description=[
                    "从 0 到 1 策划校园招聘会，主导场地、企业邀约与现场执行，"
                    "到会企业 40 家、学生 1200 人。",
                ],
                highlights=[
                    "用分时段报名数据调度入场节奏，把现场排队时间控制在 10 分钟以内。",
                    "设计企业侧的一页纸招募说明并在 3 天内完成 40 家邀约确认，到会率 92%。",
                ],
            )
        ],
        skills=[
